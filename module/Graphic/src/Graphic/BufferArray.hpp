...
public:
    ...
    T *getData() { return TraitT::data(*this); }

    const T *getConstData() const { return TraitT::const_data(*this); }
...
protected:
    BufferArray(base_type &&base) noexcept
...
namespace Graphic
{
    ...
    template<typename T>
    void copy(const VertexBufferArray<T> &src,
              std::size_t                 soffset,
              VertexBufferArray<T>       &dest,
              std::size_t                 doffset,
              std::size_t                 count)
    {
    ...
    template<typename T>
    void copy(const IndexBufferArray<T> &src,
              std::size_t                soffset,
              IndexBufferArray<T>       &dest,
              std::size_t                doffset,
              std::size_t                count)
    {
        memcpy(src, soffset * sizeof(T), dest, doffset * sizeof(T), count * sizeof(T));
    ...
    template<typename T>
    void copy(const SharedVertexBufferArray<T> &src,
              std::size_t                       soffset,
              SharedVertexBufferArray<T>       &dest,
              std::size_t                       doffset,
              std::size_t                       count)
    {
        memcpy(src, soffset * sizeof(T), dest, doffset * sizeof(T), count * sizeof(T));
    ...
    template<typename T>
    void copy(const SharedIndexBufferArray<T> &src,
              std::size_t                      soffset,
              SharedIndexBufferArray<T>       &dest,
              std::size_t                      doffset,
              std::size_t                      count)
    {
        memcpy(src, soffset * sizeof(T), dest, doffset * sizeof(T), count * sizeof(T));
