...
namespace
{
    ...
    void compile(GLuint id, const std::pair<std::size_t, std::string_view> &input)
    {
        ...
        std::string define = "#line " + std::to_string(line) + "\n";
...
opengl::Shader opengl::createShaderFromCode(std::string_view codes)
{
    ...
    opengl::Shader shader{ opengl::Shader::program_ressource_type { id } };
