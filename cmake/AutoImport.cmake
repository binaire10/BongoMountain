    ...
    local path    : ${LIB_LOCAL_PATH}")
                    ...
                    if (NOT TARGET ${LIB_NAME})
                        if (NOT EXISTS ${LIB_CMAKELIST_DIR}/CMakeLists.txt)
                            ...
                            elseif (LIB_LOCAL_PATH)
                                message(STATUS "create symlink git")
                                message(STATUS "${LIB_LOCAL_PATH} <=> ${LIB_PATH}")
                                execute_process(COMMAND ${CMAKE_COMMAND} -E create_symlink ${LIB_LOCAL_PATH}/ ${LIB_PATH} COMMAND_ECHO STDOUT WORKING_DIRECTORY ${WORKING_DIR} COMMAND_ERROR_IS_FATAL ANY)
                            else ()
